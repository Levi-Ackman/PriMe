...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="PriMe")
    parser.add_argument(
        "--model",
        type=str,
        required=True,
    ...
    parser.add_argument("--init",type=str, default="srandn",help=(
                "Initialization method for learnable query.\n"
                "Options:\n"
                "  zeros      - All zeros\n"
                "  randn      - Gaussian N(0,1)\n"
                "  srandn     - Scaled small Gaussian N(0,1e-2)\n"
                "  uniform    - Uniform [0,1)\n"
                "  const      - Constant value 0.5\n"
                "  normalized - L2-normalized random vector\n"
            )
    )
    ...
    for ii in range(args.itr):
            ...
            args.seed = seed
            setting = "{}_{}_seed_{}_dm_{}_dp_{}_tl_{}_cl_{}_llml_{}_bs_{}_lr{}_aug_{}_pl_{}".format(
                args.model,
                args.data,
                args.seed,
                args.d_model,
