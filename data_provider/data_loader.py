...
class APAVALoader(Dataset):
    def __init__(self, root_path, flag=None):
        ...
        self.embed_path = f"./Embeddings/APAVA/{flag}/"
    ...
    def __getitem__(self, index):
        ...
        return torch.from_numpy(self.X[index]), torch.from_numpy(np.asarray(self.y[index])), embeddings.squeeze(-1)
...
class TDBRAINLoader(Dataset):
    def __init__(self, root_path, flag=None):
        ...
        self.max_seq_len = self.X.shape[1]
        self.embed_path = f"./Embeddings/TDBRAIN/{flag}/"
...
class ADFTDLoader(Dataset):
    def __init__(self, root_path, flag=None):
        ...
        self.max_seq_len = self.X.shape[1]
        self.embed_path = f"./Embeddings/ADFTD/{flag}/"
...
class PTBLoader(Dataset):
    def __init__(self, root_path, flag=None):
        ...
        self.max_seq_len = self.X.shape[1]
        self.embed_path = f"./Embeddings/PTB/{flag}/"
...
class PTBXLLoader(Dataset):
    def __init__(self, root_path, flag=None):
        ...
        self.max_seq_len = self.X.shape[1]
        self.embed_path = f"./Embeddings/PTB-XL/{flag}/"
...
class MIMICIVLoader(Dataset):
    def __init__(self, root_path, flag=None):
        ...
        self.max_seq_len = self.X.shape[1]
        self.embed_path = f"./Embeddings/MIMIC/{flag}/"
